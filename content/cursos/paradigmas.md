...
- [Exercícios sobre Conceitos de Linguagens de Programação](ListaQuestoesLP.pdf)
- [Lista de Prog. Funcional](ListaExerciciosProgFuncional.pdf)
- [Lista de Prog. OO](ListaExerciciosProgOO.pdf)
...
- [Ferramenta para estudar/compreender BNF](https://bnfplayground.pauliankline.com/)
- [Ferramenta para exibição de pilha de ativação](https://pythontutor.com/visualize.html#mode=edit)
